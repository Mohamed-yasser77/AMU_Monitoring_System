...
const Sidebar = ({ activeTab, setActiveTab, userName, onLogout }) => {
    ...
    const menuItems = [
        ...
        { id: 'flocks', label: 'Flocks', icon: Activity },
        ...
        <div className="flex flex-col h-full bg-[#1c2025] text-slate-400 w-64 fixed left-0 top-0 z-30 border-r border-white/5 shadow-2xl transition-all duration-300">
            <div className="p-8">
                <div className="flex items-center gap-3 mb-12 animate-slide-up">
                    ...
                    <span className="text-sm font-bold tracking-[0.2em] text-white uppercase">Operator <span className="text-teal-accent">Dashboard</span></span>
                </div>
            ...
            <div className="mt-auto p-6 space-y-4">
                <div className="flex items-center gap-3.5 px-3 py-3 rounded-lg border border-white/5 bg-white/[0.02] group transition-all hover:bg-white/[0.05] cursor-default">
                    ...
                    <div className="overflow-hidden">
                        <p className="text-xs font-bold truncate text-white uppercase tracking-widest">{userName || 'David'}</p>
                        <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Operator</p>
                    </div>
                </div>
                <button
                    onClick={onLogout}
