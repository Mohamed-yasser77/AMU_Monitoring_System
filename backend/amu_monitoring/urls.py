"""
URL configuration for amu_monitoring project.
...
from amu_monitoring.users.views import RegisterView, UpdateProfileView
from amu_monitoring.users.login_view import LoginView
